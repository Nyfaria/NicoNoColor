...
* Rename the main package to be the same as `mod_base_package` in the properties file, e.g. `me.sizableshrimp.niconocolor`

### Using mixins?
* Delete `build.gradle`
* Rename `mixinbuild.gradle` to `build.gradle`
* Rename `niconocolor.mixins.json` to start with your mod id
* Add mixins under the `mixin` package inside your main package, e.g. `me.sizableshrimp.niconocolor.mixin`

### Not using mixins?
* Delete `mixinbuild.gradle`
* Delete `src/main/resources/niconocolor.mixins.json`
